export default {
  ...
  pptGen: {
    ...
    numPagesHelp: '0 means the model decides automatically',
    language: 'Language',
    languageAuto: 'Auto',
    template: 'Template',
    ...
    historyEmpty: 'No previous tasks yet. Create one using the form on the right.',
    newTask: 'New task',
    ...
    statusFilter: 'Status',
    statusAll: 'All',
    confirmDelete: 'Cancel this task and remove it from the list?',
    ...
    tabPreview: 'Preview',
    previewHint: 'Switch to this tab to load PDF preview (first load may be slow)',
    deleteTask: 'Delete record',
    deleteConfirmTitle: 'Delete this generation task?',
    deleteConfirmBody: 'This will remove the PPT file and intermediate artifacts on the server. This cannot be undone.',
    deleteSuccess: 'Deleted',
    deleteFail: 'Delete failed',
    deleteNeedTerminal: 'Only finished tasks (success / failed / cancelled) can be deleted',
    testNeedModel: 'Select at least one chat or vision model before testing',
    testOk: 'Connection OK',
    testFail: 'Connection failed',
    testDone: 'Test finished',
    llmLabel: 'Chat model',
    vlmLabel: 'Vision model',
  },
  // Flashcards (genai-rag style: topic + KB excerpts → LLM)
  flashcardGen: {
    title: 'Generate flashcards',
    entry: 'Flashcards',
    entryTooltip: 'Generate study flashcards from this knowledge base via the flashcard bridge',
    topic: 'Study topic',
    topicPlaceholder: 'e.g. key concepts in this chapter',
    count: 'Number of cards',
    language: 'Output language',
    llmModel: 'Chat model (optional)',
    llmPlaceholder: 'Leave empty to use deployment FLASHCARD_LLM_*',
    submit: 'Start',
    generating: 'Generating…',
    empty: 'No flashcards in this task',
    front: 'Front',
    back: 'Back',
    flip: 'Tap to flip',
    close: 'Close',
    error: 'Generation failed',
    healthFail: 'Flashcard bridge unavailable. Ensure the flashcard container is running.',
    history: 'Recent tasks',
    historyEmpty: 'No tasks yet. Click "New task" to start.',
    newTask: 'New task',
    refresh: 'Refresh',
    pickOrCreate: 'Select a task on the left or create a new one',
    tabProgress: 'Progress',
    tabPreview: 'Preview',
    taskCreated: 'Flashcard task created',
    taskId: 'Task ID',
    createdAt: 'Created at',
    filesIncluded: 'Files included',
    filesSkipped: 'Files skipped',
    ...
    deleteTask: 'Delete record',
    deleteConfirmTitle: 'Delete this flashcard task?',
    deleteConfirmBody: 'This removes the saved flashcards and cannot be undone.',
    deleteSuccess: 'Deleted',
    deleteFail: 'Delete failed',
    deleteNeedTerminal: 'Only finished tasks (success/failed) can be deleted',
    listFail: 'Failed to load task list',
    pollFail: 'Failed to poll task status',
