export default {
  ...
  pptGen: {
    ...
    taskId: "任务 ID",
    history: "最近任务",
    historyEmpty: "暂无生成记录，使用右侧表单创建第一个任务。",
    newTask: "新建任务",
    backToList: "返回列表",
    refresh: "刷新",
    createdAt: "创建时间",
    ...
    tabProgress: "进度",
    tabPreview: "预览",
    previewHint: "切换到本标签后将加载 PDF 预览（首次可能较慢）",
    deleteTask: "删除记录",
    deleteConfirmTitle: "删除此生成任务？",
    deleteConfirmBody: "将同时删除服务器上的 PPT 文件与中间产物，且不可恢复。",
    deleteSuccess: "已删除",
    deleteFail: "删除失败",
    deleteNeedTerminal: "仅已结束（成功/失败/已取消）的任务可删除",
    testNeedModel: "请至少选择一个对话模型或视觉模型后再测试",
    testOk: "连接成功",
    testFail: "连接失败",
    testDone: "测试完成",
    llmLabel: "对话模型",
  ...
  // 闪卡（参考 genai-rag：主题 + 知识摘录 → LLM 生成闪卡）
  flashcardGen: {
    title: "生成闪卡",
    entry: "生成闪卡",
    entryTooltip: "基于本知识库文档，调用闪卡服务生成可复习的问答闪卡",
    topic: "学习主题",
    topicPlaceholder: "例如：本章核心概念、考试重点",
    count: "闪卡数量",
    language: "输出语言",
    llmModel: "对话模型（可选）",
    llmPlaceholder: "不选则使用部署环境 FLASHCARD_LLM_*",
    submit: "开始生成",
    generating: "正在生成…",
    empty: "暂无闪卡内容",
    front: "正面",
    ...
    close: "关闭",
    error: "生成失败",
    healthFail: "闪卡服务不可用，请检查是否已启动 flashcard 容器",
    history: "最近任务",
    historyEmpty: "暂无生成记录，点击「新建任务」开始",
    newTask: "新建任务",
    refresh: "刷新",
    pickOrCreate: "请从左侧选择任务查看进度与预览，或点击「新建任务」",
    tabProgress: "进度",
    tabPreview: "预览",
    taskCreated: "闪卡任务已创建",
    taskId: "任务 ID",
    ...
    restart: "重新生成",
    deleteTask: "删除记录",
    deleteConfirmTitle: "删除此闪卡任务？",
    deleteConfirmBody: "将移除服务器上的任务记录与已保存的闪卡内容，且不可恢复。",
    deleteSuccess: "已删除",
    deleteFail: "删除失败",
    deleteNeedTerminal: "仅已结束（成功/失败）的任务可删除",
    listFail: "加载任务列表失败",
    pollFail: "查询任务状态失败",
    viewCards: "查看闪卡",
  },
